...
def store_tt_tensor(tt_tensor, path, internal_path, compression="gzip",
    ...
    """Store a TTTensor to file
    
    Parameters
    ----------
    tt_tensor : TTTensor
        Tensor train-tensor object to store.
    ...
    **kwargs
    ...
    >>> tt = random_tt_tensor((10, 15, 20), 3)
    ... store_tt_tensor(tt, "checkpoint_file.h5")
    ... loaded_tt = load_tt_tensor("checkpoint_file.h5")

    Store multiple decompositions in a single file

    >>> tt_1 = random_tt_tensor((10, 15, 20), 3)
    ... tt_2 = random_tt_tensor((10, 15, 20), 5)
    ... store_tt_tensor(tt_1, "checkpoint_file.h5", internal_path="rank3")
    ... store_tt_tensor(tt_2, "checkpoint_file.h5", internal_path="rank5")
    ... loaded_tt1 = load_tt_tensor("checkpoint_file.h5", "rank3")
    ... loaded_tt2 = load_tt_tensor("checkpoint_file.h5", "rank5")
    """
...
def load_tt_tensor(path, internal_path):
    """Load a TT tensor decomposition from file
